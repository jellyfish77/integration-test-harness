...
public class JMSTester implements javax.jms.MessageListener {
	...
	private void sendTextMessage(String strMessage) {
		try {		
	...
	public void onMessage(Message message) {
		...
		try {
			...
			System.out.println("JMSDeliveryMode: " + (javax.jms.DeliveryMode.PERSISTENT == message.getJMSDeliveryMode() ? "PERSISTANT" : "NONPERSISTANT"));
			System.out.println("JMSMessageID: " + message.getJMSMessageID());
			System.out.println("JMSTimestamp: " + message.getJMSTimestamp() + " (" + (System.currentTimeMillis() - message.getJMSTimestamp()) + "ms)");
			//System.out.println("<currentTimeMillis: " + System.currentTimeMillis() + ">");
			//System.out.println("Duration (ms): " + (System.currentTimeMillis() - message.getJMSTimestamp()));
	...
	public static void main(String argv[]) {
		...
		*/
		...
		int numMessages = 0;
		if (argv.length == 4) {
			connFactoryName = argv[0];
			inDestName = argv[1];
			outDestName = argv[2];
			numMessages = Integer.parseInt(argv[3]);
		} else {
			System.out.println("Invalid arguments. Should be: ");
			System.out.println("java JMSTester connFactoryName inDestName outDestName numMessages");
			System.exit(0);
		}
		...
		env.put(Context.PROVIDER_URL, "tcp://192.168.1.201:61616");
		
		JMSTester jmsTester = new JMSTester(env, connFactoryName, inDestName, outDestName);
...
//		}
		...
		try {
			...
			//System.out.println("[MESSAGE PRODUCED] (JMSMessageID: " + mapMessage.getJMSMessageID() +")");			
